 ...
 *
 * @param array $sidebar_args Arguments sidebar.
 * @return array
 */
function wp_widget_control( $sidebar_args ) {
	...
	echo esc_html( $sidebar_args['before_widget'] ); ?>
	<div class="widget-top">
	<div class="widget-title-action">
		<a class="widget-action hide-if-no-js" href="#available-widgets"></a>
		<a class="widget-control-edit hide-if-js" href="<?php echo esc_url( add_query_arg( $query_arg ) ); ?>">
			<span class="edit"><?php esc_html_ex( 'Edit', 'widget' ); ?></span>
			<span class="add"><?php esc_html_ex( 'Add', 'widget' ); ?></span>
			<span class="screen-reader-text"><?php echo esc_html( $widget_title ); ?></span>
		</a>
	</div>
	...
	<?php echo esc_html( $before_form ); ?>
	<?php echo esc_html( $before_widget_content ); ?>
	<?php
	if ( isset( $control['callback'] ) ) {
		$has_form = call_user_func_array( $control['callback'], $control['params'] );
	} else {
		echo "\t\t<p>" . esc_attr__( 'There are no options for this widget.' ) . "</p>\n";
	}
	?>
	<?php echo esc_html( $after_widget_content ); ?>
	...
	<div class="widget-control-actions">
		<div class="alignleft">
		<a class="widget-control-remove" href="#remove"><?php esc_html_e( 'Delete' ); ?></a> |
		<a class="widget-control-close" href="#close"><?php esc_html_e( 'Close' ); ?></a>
		</div>
		<div class="alignright<?php if ( 'noform' === $has_form ) { echo ' widget-control-noform';} ?>">
			<?php submit_button( __( 'Save' ), 'button-primary widget-control-save right', 'savewidget', false, array(
	...
	<?php echo esc_html( $after_form ); ?>
	</div>

	<div class="widget-description">
<?php
	$widget_description = wp_widget_description( $widget_id );
	echo ( esc_html( $widget_description ) ) ? esc_html( "$widget_description\n" ) : esc_html( "$widget_title\n" ); ?>
	</div>
<?php
	echo esc_html( $sidebar_args['after_widget'] );

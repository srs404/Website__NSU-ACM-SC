...
function wp_read_image_metadata( $file ) {
	 ...
	 */
	if ( is_callable( 'exif_read_data' ) && in_array( $source_image_type, apply_filters( 'wp_read_image_metadata_types', array( IMAGETYPE_JPEG, IMAGETYPE_TIFF_II, IMAGETYPE_TIFF_MM ) ) ) ) {
	 ...
	 */
	return apply_filters( 'wp_read_image_metadata', $meta, $file, $source_image_type, $iptc );
